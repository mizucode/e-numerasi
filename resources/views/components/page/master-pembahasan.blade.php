  ...
  @php
    $cards = [
      [
        ...
        'url' => 'materi-bilangan-pembahasan'
      ],
      [
      ...
      [
        ...
        'url' => 'materi-data-dan-ketidakpastian-pembahasan'
      ],
        ...
        @foreach ($cards as $card)
          <div
            ...
            <div class="p-5 flex flex-col flex-grow">
              <h3 class="font-bold text-lg md:text-xl mb-2 text-gray-800">Pembahasan {{ $card['title'] }}</h3>
